...
def parse_args():
    ...
    parser.add_argument("-w, --write", dest='save', action='store_true', help = "Indicate that logfiles should be saved to the matches directory", default = False)
...
def play_game(player_names, ai_players, ai_files, stats, save_logfile, verbose=False):
    ...
    logname = 'matches' + os.path.sep + 'RISKTOURNAMENT'
